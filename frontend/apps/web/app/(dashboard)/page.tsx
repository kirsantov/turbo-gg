  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">Welcome to your Invoice OCR dashboard</p>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Link
            ...
            className="flex items-center space-x-4 rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow-md"
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100">
              <svg
                className="h-6 w-6 text-blue-600"
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Process new invoice with OCR</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Browse all processed invoices</p>
            </div>
          </Link>
      ...
      <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
        ...
        <p className="mb-4 text-blue-700">
          Upload your first invoice to start automating your workflow
        </p>
        <Link
          href="/dashboard/upload"
